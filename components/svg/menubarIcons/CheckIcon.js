export default function CheckIcon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="bi bi-clipboard-check" height={props.height} width={props.width} fill={props.fill} className={props.className}>
