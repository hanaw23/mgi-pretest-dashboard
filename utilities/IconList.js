...
export const firstMenuIcon = [
  {
    id: 1,
    icon: <HomeIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 2,
    icon: <TicketIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 3,
    icon: (
  ...
  {
    id: 4,
    icon: <BoxIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
];
...
export const secondMenuIcon = [
  {
    id: 1,
    icon: <MemberIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 2,
    icon: <LayerIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 3,
    icon: <BoxCloseIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 4,
    icon: <RectangleIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
  {
    id: 5,
    icon: <SearchDollarIcon height={20} width={20} fill="#767676" className="mb-8" />,
  },
];
